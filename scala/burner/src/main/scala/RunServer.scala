...
object RunServer {
  ...
  private val inputFeatureSize: Int = evalJNI.getInputFeatureSize
  private val inputSequenceSize: Int = evalJNI.getInputSequenceSize
  private val outputSize: Int = evalJNI.getOutputSize
